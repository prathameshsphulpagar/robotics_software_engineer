...
private:
  ...
  {
    float rightObstacle = *std::max_element(lidarMsg->ranges.begin() + 80,
                                            lidarMsg->ranges.begin() + 100);
    float frontObstacle = *std::max_element(lidarMsg->ranges.begin() + 170,
                                            lidarMsg->ranges.begin() + 190);
    float leftObstacle = *std::max_element(lidarMsg->ranges.begin() + 260,
